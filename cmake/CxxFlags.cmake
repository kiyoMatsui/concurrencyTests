## RELEASE Flags
#to make sure it is not optimising out benchmarks
SET(CMAKE_CXX_FLAGS_RELEASE "${CMAKE_CXX_FLAGS_RELEASE} -Wall -O3" ) # -O3")

## DEBUG Flags
### Forcing the compiler to work harder helps finding potential problems

SET(CMAKE_CXX_FLAGS_DEBUG "${CMAKE_CXX_FLAGS_DEBUG} -g -O0 -fprofile-arcs")
...
### Warn whenever a local variable shadows another local/global one for gsl-lite
...
### Warn whenever a switch has an index of enumerated type and lacks a case CHANGED FOR ASIO
SET(CMAKE_CXX_FLAGS_DEBUG "${CMAKE_CXX_FLAGS_DEBUG} -Wswitch-enum")
### Warn for implicit conversions that may alter a value CHANGED FOR ASIO
